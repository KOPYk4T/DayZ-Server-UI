...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::sync::sync_write,
            commands::sync::sync_fetch,
            ...
            commands::profile_jsons::profile_jsons_scan,
            commands::profile_jsons::profile_jsons_set_override,
            commands::profile_jsons::profile_jsons_reset_overrides,
            commands::profile_jsons::profile_jsons_read,
            commands::profile_jsons::profile_jsons_write,
            commands::profile_jsons::profile_jsons_delete,
